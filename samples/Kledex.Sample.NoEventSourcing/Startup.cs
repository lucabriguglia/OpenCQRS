...
using Kledex.Sample.NoEventSourcing.Domain.Commands.Handlers;
...
namespace Kledex.Sample.NoEventSourcing
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddKledex(typeof(CreateProduct), typeof(CreateProductHandler), typeof(GetProduct))
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, SampleDbContext dbContext, IOptions<DomainDbConfiguration> settings)
        {
